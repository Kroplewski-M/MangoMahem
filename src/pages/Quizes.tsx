  ...
  return (
    <div className="md:px-16 pt-5">
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:ml-16 ml-[2px] mt-5 md:mt-0 bg-secondary rounded hover:bg-secondary/90 w-[200px]" onClick={() => navigate("/create-quiz")}>
      ...
      <div>
        <label htmlFor="Filter" className="font-bold text-PrimaryText text-[20px] mr-[10px] block md:inline mt-5 md:mt-0">
          Filter:
        </label>
